...
VS.Player={Version:"2.1.0",_containerId:"videostir-player",_containerInnerId:"videostir-player-inner",_preloadContainerId:"videostir-player-preload",_playerUrl:"http://8b249279a23ebe6382fe-bdbb90f389a017a4d0321ddd645160f1.r73.cf1.rackcdn.com/swf/130318/vs.player.swf",init:function(){},parseLegacyVideo:function(c){if(-1!==c.indexOf("://videostir.com/")){var d=c.match(/\/go\/video\/([a-z0-9]{32})/);return d&&2===d.length?d[1]:c}return c},show:function(c,d,b,a,e){e=e||{};VS.Player.isExists()&&VS.Player.remove();
a=VS.Player.parseLegacyVideo(a);VS.Stats.setHash(a);if(e["fake-show-every"]&&Math.floor(Math.random()*e["fake-show-every"]+1)===parseInt(e["fake-show-every"]))VS.Stats.trigger("jsFakeShow");else{var i=new VS.Player.Cookie(a),h=i.getViewsCount();if(e["disable-player-threshold"]){if(h>=e["disable-player-threshold"])return;delete e["disable-player-threshold"]}e.videostir_views=h;var f=VS.Player.makeCss(c,d,b),g=VS.Player.makePlayerParams(a,e);VS.Stats.trigger("jsShow",VS.jQuery.extend({},{position:c,
...
VS.Player._containerInnerId,d,b,"9.0.0","",g.flashvars,g.params,g.attributes);i.addViewsCount()})}},createPreloadContainer:function(){0===VS.Player._preloadContainerCounter&&VS.jQuery("body").append('<div id="'+VS.Player._preloadContainerId+'"></div>')},removePreloadContainer:function(){var c=VS.jQuery("#"+VS.Player._preloadContainerId);if(c.length){for(var d=c.find("> *"),b=0,a=d.length;b<a;b++)VS.swfobject.removeSWF(VS.jQuery(d[b]).attr("id"));c.remove()}},_preloadContainerCounter:0,addPreloadingItemContainer:function(){VS.Player._preloadContainerCounter++;
...
"newWindow";break;case "self":b.flashvars.goButtonLogic="sameWindow"}break;case "on-click-open-url-button-position":b.flashvars.goButtonFrame=1;switch(d[a]){case "left":case "center":case "right":b.flashvars.goButtonLocation=d[a]}break;case "clip-fps":b.flashvars.clipFps=d[a];break;case "playback-freeze-frame":b.flashvars.freeze=d[a];break;default:b.flashvars[a]=d[a]}b.flashvars.freeze&&(b.flashvars.autop=!0,b.flashvars.maxPlayedTimes=1E4);return b},getReferrer:function(){return window.location.href},
getPlayerUrl:function(c){return c?"https"+VS.Player._playerUrl.replace(/\.r[0-9]{2}\./,".ssl.").substr(4):VS.Player._playerUrl},isSecure:function(){return"https:"==document.location.protocol?!0:!1}};VS.Player.Cookie=function(c){var d,b;this.getViewsCount=function(){return b?b:0};this.addViewsCount=function(a){a=a||1;VS.jQuery.cookie(d,b+a,{expires:365});b+=a};d="vsv"+c;b=(b=VS.jQuery.cookie(d))?parseInt(b):0};
...
a.match(/(as-[a-z0-9]{32}|[a-z0-9]{32})/))&&2===a.length?a[1]:!1},generateSessionId:function(){return parseInt(Math.floor(428*Math.random()+11)+""+((new Date).getTime()+"").substr(6))},bindListenners:function(){c(b).bind("jsShow jsDomReady jsUnload jsFakeShow jsPreload initFlash startLoading finishLoading loadError pause play mute unmute remove playbackPosition gotoLink gotoHome conversion".split(" ").join(".vs-player ")+".vs-player",function(b,c){a.log(b.type,c)});c(d).bind("beforeunload",function(){a.log("jsUnload")})},
trigger:function(a,d){(d=d||!1)?c(b).trigger(a+".vs-player",[d]):c(b).trigger(a+".vs-player")},_conversionElement:null,triggerConversion:function(b){var d=c(b.currentTarget);a._conversionElement=d;d.is("a")&&b.preventDefault();b=b.currentTarget.nodeName;d.attr("vs-conversion-id")&&(b+=" conversion-id="+d.attr("vs-conversion-id"));a.trigger("conversion",b)},log:function(b,c){var d=a._sequenceNumber++,f=(new Date).getTime()-VS._zeroTime,g=0;a.isJunkEvent(b,f,c)||(a._level&a.SEND_CONSOLE&&console.log(a._videoHash,
a._sessionId,d,f,b,c?c:""),a._level&a.SEND_SERVER&&(a.sendEvent(d,f,b,c),g=1),a._stack.push([g,d,f,b,c]))},isJunkEvent:function(b,c,d){var f=!1;if(!a._stack.length)return f;var g=a._stack[a._stack.length-1];"playbackPosition"===b?g[4]===d&&(f=!0):g[3]===b&&100>Math.abs(c-g[2])&&(f=!0);return f},sendEvent:function(b,i,h,f){c.ajax({type:"get",url:a._statsUrl,data:{h:a._videoHash,s:a._sessionId,n:b,t:i,e:h,d:f},async:"jsUnload"===h?!1:!0,crossDomain:!0,cache:!1,dataType:"jsonp",jsonp:"vs",jsonpCallback:"_",
processData:!0,timeout:a._sendTimeout,fail:function(){d.log&&console.log("sendEvent ajax fail",arguments)},complete:function(){"conversion"==h&&(a._conversionElement&&a._conversionElement.is("a"))&&(d.location=a._conversionElement.attr("href"),a._conversionElement=null)}})}};d.VS.Stats=a;a.init()})(VS.jQuery,window,document);
