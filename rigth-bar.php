...
<div id="formdiv" class="postbox " style=" box-shadow: 0 5px 15px rgba(0,0,0,0.15);border: 1px solid rgba(0,0,0,0.25);" >
    <div class="inside">
        ...
        <p style="margin-top: 0px;">Just shoot a short video based on <a href="http://videostir.com/guidelines?utm_source=wp-plugin&utm_medium=plugin&utm_campaign=wp-plugin">our guidelines</a> (one-colored wall etc.)</p>

        <h4 style="margin-bottom: 2px;">2. Transform your video into a floating clip in 3 simple steps.</h4>
        <p style="margin-top: 0px;">Our VideoStir Engine will create a background-less floating clip in just a few minutes.
                        <br>If you recorded your video, <a href="" onclick="window.open('http://videostir.com/?page=wp//&start-step=1')">click here</a> to start the process. </p>

        <h4 style="margin-bottom: 2px;">3. Add your new floating clip to your Wordpress site.</h4>
        <p style="margin-top: 0px;"Simply embed it into any Page/Post of your choice using this plugin.</p>

        <p>Visit us at <a target="_blank" href="http://videostir.com/?utm_source=wp-plugin&utm_medium=plugin&utm_campaign=wp-plugin">http://videostir.com</a> for more information</p>
    </div>
</div>

<div id="formdiv" class="postbox " style=" box-shadow: 0 5px 15px rgba(0,0,0,0.15);border: 1px solid rgba(0,0,0,0.25);" >
    <div class="inside">
        <h3>See a floating clip in action” - and underneath the “BING DEMO</h3>
        <iframe src="https://videostir.com/demo/test-on-outside?page=wp" width="370" height="110" style="padding:0px;" align="center"></iframe>
    </div>
</div>

<div id="formdiv" class="postbox " style=" box-shadow: 0 5px 15px rgba(0,0,0,0.15);border: 1px solid rgba(0,0,0,0.25);" >
    <div class="inside">
        <h3>Ready to make your first clip?</h3>
        <iframe src="https://videostir.com/demo/start-on-outside/?page=wp" width="370" height="100" style="padding:5px;margin-left:-25px;" align="center"></iframe>
    </div>
</div>
